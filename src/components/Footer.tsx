    ...
    <footer className="border-t border-[var(--border-color)] bg-[var(--surface)]">
      <div className="mx-auto max-w-[1280px] px-6 md:px-12 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          {/* Center — Quick links */}
          <div className="space-y-4">
            <h4 className="font-[family-name:var(--font-heading)] font-semibold text-sm uppercase tracking-wider text-[var(--text-secondary)]">
              Links
            </h4>
